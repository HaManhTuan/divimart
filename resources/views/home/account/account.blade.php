          ...
          <div class="card wow fadeInUp" data-wow-delay=".25s">
            ...
            <div class="card-body">
              ...
              <form action="{{ url('account/edit-account') }}" class="frm-account" method="POST" id="frm-account">
                ...
                @if (Auth::guard('customers')->user()->coupon !='')
                                  <div class="form-group">
                  <label for="exampleInputPassword1">Bạn có mã giảm giá mới:</label>
                  <input type="text" class="form-control" name="coupon" value="{{ Auth::guard('customers')->user()->coupon }}" readonly="">
                </div>
                @endif
