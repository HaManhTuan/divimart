...
<link rel="stylesheet" href="{{ asset('public/admin/css/bootstrap-4.css')}}">
  ...
  <link rel="stylesheet" href="{{ asset('public/admin/css/croppie.css') }}">
...
<script src="{{ asset('public/admin/js/croppie.js')}}"></script>
...
<script>
    $(window).scroll(function() {
        ...
        dh = $(document).height(),
        wh = $(window).height();
        scrolPercent = (scroll / (dh-wh)) * 100;
        $('#progessbar').css('height', scrolPercent + '%');
    });
</script>
</body>
</html>
