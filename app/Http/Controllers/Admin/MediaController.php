...
class MediaController extends Controller {
	...
	public function editModal(Request $req) {
      ...
      <input type="file" id="input-file-now" name="image" class="dropify" data-rule-required="true" data-default-file="'.asset('public/uploads/images/sliders/').'/'.''.$media_edit->image.'" >
      <input type="hidden" name="old_file" value="'.$media_edit->image.'" />
      </div>
      <div class="form-group">
      <label for="category_name_input" class="control-label">Mô tả<font color="#a94442">(*)</font></label>
