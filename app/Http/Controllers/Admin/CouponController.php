...
class CouponController extends Controller {
	...
	public function editmodal(Request $req) {
		...
		<input type="text" class="form-control" data-date-format="dd-mm-yyyy" id="expiry_date_edit" name="expiry_date" value="'.$detailCoupon->expiry_date.'" data-rule-required="true" data-msg-required="Vui lòng nhập ngày.">
		</div>
		<div class="form-group">
		...
		$data .='<script>$("#edit-coupon-modal #expiry_date_edit").datepicker({ format: "dd-mm-yy"});
		</script>';
		$msg = array(
